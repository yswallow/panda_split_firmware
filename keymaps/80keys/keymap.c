...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_EUCALYN] = LAYOUT80( \
        LALT_T(KC_Q), KC_MINUS, KC_COMM, KC_DOT, KC_W,      KC_M, KC_Y, KC_K, KC_R, RALT_T(KC_P),   KC_7, KC_8, KC_9, KC_TAB, KC_DELETE,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        LCTL_T(KC_A), KC_O, KC_E, KC_I, KC_U,               KC_N, KC_H, KC_J, KC_L, RCTL_T(KC_G),   KC_4, KC_5, KC_6, KC_ENT, LCTL(KC_W),    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_F,               KC_S, KC_T, KC_D, KC_B, RSFT_T(KC_Q),   KC_1, KC_2, KC_3, KC_UP, KC_RALT,       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
        LCTL_T(KC_ESC),KC_LGUI, LT(_ARROW, KC_F10), LT(_LOWER, KC_TAB), LT(_LOWER, KC_SPC),    LT(_RAISE, KC_ENT), KC_BSPACE, LCTL(KC_SPC), KC_APP, KC_RGUI,
                                                                                                    KC_0, KC_DOT, KC_LEFT, KC_DOWN, KC_RIGHT,    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
),
